...
def getRxGrammar():
    ...
    [   "scan0",
        ...
        "",
        "select(op,name,captype,capture,a(4),'{ typedef decltype('+a(1)+'->'+a(2)+') _'+a(3)+'; auto accumulate = [](_'+a(3)+' '+a(3)+',type1 '+a(4)+')'+a(5)+'; auto project = [](_'+a(3)+' '+a(6)+'){ return '+a(7)+';}; '+a(1)+'->'+a(2)+' = accumulate('+a(1)+'->'+a(2)+','+a(4)+'); return project('+a(1)+'->'+a(2)+'); }')"], 
    [   "selectmany",
